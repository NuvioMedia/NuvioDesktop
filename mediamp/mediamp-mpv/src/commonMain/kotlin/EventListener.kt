...
interface EventListener {
    ...
    /**
     * Notify end of file event.
     * @param reason one of MPV_END_FILE_REASON_EOF (0), _ERROR (1), _STOP (2), _QUIT (3), _REDIRECT (4)
     * @param error mpv error code string, non-empty only when reason == MPV_END_FILE_REASON_ERROR
     */
    fun onEndFile(reason: Int, error: String) = Unit
}